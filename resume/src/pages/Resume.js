    ...
    <Section name="resume" images={null}>
      <div className="flex flex-col divide-y-2 divide-neutral-300">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 grid-rows-3 auto-cols-fr auto-rows-fr gap-4">
            <div className="col-span-1 flex flex-row gap-x-14">
            ...
            <div className="col-span-1 flex flex-row gap-x-14">
                <img style={{width: "80%", height: "80%"}}  src={WorkExperienceData[2].image} ></img>
